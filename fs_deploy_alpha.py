...
print(ranking[ranking['基金代码']==fundcode]['分项合计-产品'].item())
score_product = ranking[ranking['基金代码']==fundcode]['分项合计-产品'].item().astype('float').round(2)
score_manager = ranking[ranking['基金代码']==fundcode]['分项合计-经理'].item().astype('float').round(2)
score_company = ranking[ranking['基金代码']==fundcode]['分项合计-公司'].item().astype('float').round(2)
score_final = ranking[ranking['基金代码']==fundcode]['综合得分'].item().astype('float').round(2)
